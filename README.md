...
`mvn clean` => This command will clean the project, copy dependencies, and package the project (executing all phases up to package, of course).
...
`mvn test` => Run all the unit test classes. You can look at the documentation generated under target/site/jacoco/ (if plugin jacoco is installed)